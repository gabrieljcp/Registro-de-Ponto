<script setup>
    ...
    const { colaborador, getColaborador, updateColaborador, errors} = useColaboradores();
    const cargos = ref([]);
    const funcoes = ref([]);
    ...
    onMounted(() => getColaborador(props.id))
    onMounted(async () => {
...
<template>
    <div class="flex flex-col items-center justify-center py-12">
        <div class="header text-gray-700 text-5xl font-bold text-center mb-8">Alterar Colaborador</div>
        <form class="w-full max-w-2xl bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4"
        @submit.prevent="updateColaborador($route.params.id)"> 
            <div class="mb-4">
                <label for="cpf" class="block text-gray-700 text-sm font-bold mb-2">CPF</label>
                <input type="text" id="cpf" v-mask="'###.###.###-##'" v-model="colaborador.cpf"
            ...
            <div class="mb-6 max-w">
                ...
                <input type="text" id="nome" v-model="colaborador.nome"
            ...
            <div class="mb-6 max-w">
                ...
                <input type="text" id="email" v-model="colaborador.email"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 ">
            ...
            <div class="mb-6">
                ...
                <input type="text" id="telefone" v-model="colaborador.telefone"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 ">
            ...
            <div class="mb-6">
                <label for="data_nascimento" class="block mb-2 text-sm font-medium text-gray-900">Data de
                    Nascimento</label>
                <input type="date" id="data_nascimento" v-model="colaborador.data_nascimento"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
            ...
            <div class="mb-6">
                ...
                <select id="cargo_id" v-model="colaborador.cargo_id"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
            ...
            <div class="mb-6">
                ...
                <select id="funcao_id" v-model="colaborador.funcao_id"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
            ...
            <div class="mb-6">
                ...
                <input type="date" id="data_admissao" v-model="colaborador.data_admissao"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
            ...
            <div class="mb-6">
                ...
                <input type="date" id="data_rescisao" v-model="colaborador.data_rescisao"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
            ...
            <div class="mb-6">
                ...
                <input type="text" id="usuario" v-model="colaborador.usuario"
            ...
            <div class="mb-6">
                <input id="remember" type="checkbox" value="" v-model="colaborador.telefone"
            ...
            <div class="mt-4">
                <button type="submit"
                    class="px-4 py-2 bg-indigo-500 hover:bg-indigo-700 text-white rounded">Editar</button>
            </div>
